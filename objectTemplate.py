...
class objectTemplate :
    ...
    masterTemplate3 = [[50,[2,2],0],[50,[2,27],1],[50,[2,52],2],[50,[2,77],3]]#[[50,[2,2],0],[50,[2,27],1],[50,[2,52],2],[50,[2,77],3],
        ...
        self.templateList = {
			...
			11 : {
 			...
 			50 : {
 	            ...
 	            "objList": [],
                "size": [8,14],
                "objListRot":  [[0,1,1,0],[1,2,2,0],[2,3,3,0],[3,4,4,0],[4,5,5,0],[5,6,6,0],[6,7,7,0],[7,8,8,0],[8,9,9,0],[9,10,10,0],[10,11,11,0],[11,12,12,0],[12,13,13,0]
                                ,[50,15,15,0],[51,16,16,0],[52,17,17,0],[53,18,18,0],[54,19,19,0],[55,20,20,0],[56,21,21,0],[57,22,22,0],[58,23,23,0],[59,24,24,0]],#,[59,24,24,0]],#♦[[50,1,1,0],[51,7,12,3],[0,4,0,0],[3,2,2,0],[4,3,3,0],[5,4,4,0],[52,5,5,0]],#,[2,0,12,1],[1,0,4,1]],#],#[self.obj(3,0,0),self.obj(4,5,11,1)],#[[101,0,11],[130,6,0],[-263,6,1.7],[109,0.5,3],[18,1,0],[-141,6,11],[44,4.7,11.5]],
